...
| N22 | Runbook: a RunPod volume mounted at `/workspace` shadows the image's source tree, so a clone at the image commit is always required | B55 §4, §9 |
